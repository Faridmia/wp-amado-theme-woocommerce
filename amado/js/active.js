        ...
        $(this).slider({
            ...
            slide: function (event, ui) {
                ...
                //ajax start
                    ...
                    var price_data = {
                        action: 'getProductByPrice',
                        minprice: minprice,
                        maxprice: maxprice
                    };
                   $.post( wc_add_to_cart_params.ajax_url, price_data, function( msg ) {
                        console.log(msg.my_price);
                        console.log(msg.max_myprice);
                        $('.amado_product_area').html(msg.my_price);
                        $('.amado_product_area').html(msg.max_myprice);
                    },'json');
